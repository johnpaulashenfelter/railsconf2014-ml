...
#   - Take first and second columns of u
#   - Take first and second columns of vt
#   - Take the first two eigen-values
...
# Remove all users who fall below the cosine similarity cutoff and sort by similarity
